...
const LexicalTypeaheadMenuPlugin = React.lazy(() => import("@lexical/react/LexicalTypeaheadMenuPlugin").then((mod) => ({ default: mod.LexicalTypeaheadMenuPlugin<ComponentPickerOption> })))
